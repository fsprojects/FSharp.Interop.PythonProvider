...
let projects = [|"PythonTypeProvider"
                 "PythonTypeProviderProxy"|]

let summary = "Early experimental F# type provider for python."
let description = "Early experimental F# type provider for python."
let authors = ["Don Syme"; "Gustavo Guerra"; "Jon Harrop" ]
let tags = "F# fsharp typeproviders python"
